                        ...
                        <div className='mint-nft border-2 border-[#E4A841] rounded-2xl py-[57px] px-[40px]'>
                            ...
                            <form className='mt-[38px]'>
                                ...
                                <div className=''>
                                    ...
                                    <button onClick={mint} type="button" className='md:text-[30px] text-[20px] mt-[50px] mb-[15px] font-bold bg-[#E4A841] w-full py-[19px] leading-[54px] rounded-xl block text-center'>Mint</button>
                                </div>
